...
import com.rest.come.assureNG.WholeResponse;
	...
	public class Steps  {
	    ...
	    public void i_like_to_holiday_in_sydney() throws ParseException, JsonParseException, JsonMappingException, IOException {
	    	...
	    	System.out.println("DISCLAIMER--Hello !! With free subsricption you are entitled for only a 5 days weather forecast starting today");
	...
	if (temp>10) {
		...
		if (Thur_Day_Present == false) {System.out.println("Oh seems like there is no Thursday in your search.Please refer disclaimer ");
